   ...
   console.log("photostory props ", this.props)
    return (
      <Segment vertical>
        ...
        <Photo photos={this.props.photostory.photos} history={this.props.history} editCaptionInState={this.props.editCaptionInState} currentUser={this.props.photostory.user_id}/>
      </Segment>
    )
  }
}
