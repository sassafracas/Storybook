  ...
  render(){
    return (
      <div style={{"background-image": "url(http://www.allwhitebackground.com/images/2/2280.jpg)", "height": window.innerHeight}}>
        <Header style={{"margin-bottom": "10%", "letter-spacing": "4px", "padding-top": "10%"}} as="h1">S T O R Y  B O O K</Header>
        <Segment  padded compact floated="left" style={{"margin-left": "29%", "font-size": "20px", "width" : "520px"}}>
